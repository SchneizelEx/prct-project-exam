...
<div class="wrap">
  ...
  <section class="role" data-role="student">
        ...
        <div>
          ...
          <div class="step-body">
            ...
            <ul class="field-list">
              ...
              <li><span class="field">สมาชิกร่วมโครงงาน</span> — ติ๊กเลือกเพื่อนร่วมกลุ่มเพิ่มได้สูงสุด 4 คน (รวมตัวเองแล้วไม่เกิน 5 คน)</li>
    ...
    <div class="callout">
      ...
      <p>ลงทะเบียนล่วงหน้าอย่างน้อย <b>7 วัน</b> ก่อนวันสอบ และครูต้องกดอนุมัติก่อนวันสอบอย่างน้อย <b>2 วัน</b> โครงงานจึงจะมีชื่ออยู่ในคิวสอบ — ควรลงทะเบียนแต่เนิ่นๆ เพื่อให้ครูมีเวลาตรวจและอนุมัติทัน</p>
    </div>
    ...
    <div class="faq">
      ...
      <div class="faq-item">
        ...
        <div class="a">สมาชิกแต่ละคน (รวมตัวเอง) ลงทะเบียนได้เพียง 1 โครงงานต่อ 1 วันสอบ ตรวจสอบว่ามีเพื่อนในกลุ่มไปสมัครโครงงานอื่นไว้ในวันเดียวกันหรือไม่</div>
      </div>
      <div class="faq-item">
  ...
  <section class="role" data-role="teacher" hidden>
    ...
    <p class="role-sub">สำหรับครูที่ปรึกษาโครงงาน ใช้ตรวจสอบและอนุมัติคำขอสอบของนักเรียนในความดูแล</p>
    ...
    <h3 class="section-h">ขั้นตอนการตรวจและอนุมัติคำขอสอบ</h3>
    <ol class="steps">
      <li>
        <div>
          <div class="step-title">เข้าสู่ระบบ</div>
